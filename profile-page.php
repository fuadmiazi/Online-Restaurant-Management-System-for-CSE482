            ...
            <div class="profile flex flex-col justify-center items-center mt-[100px] gap-32">
               <div class="pic-name-profile flex justify-center items-center gap-14">
                  ...
                  <div class="profile-name text-white">
                     ...
                     <div class="profile-bio text-white">
                        ...
                        <p class="w-[500px]">
                           Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsam nam non quia nihil explicabo numquam.
                        </p>
                     </div>
                  </div>
               </div>
               ...
               <div class="prev-card text-white">
                  ...
                  <div class="order-cards grid grid-cols-4 gap-8">
                     ...
                     >
                        <a class="" href=""
                           ><img class="w-[300px] h-[200px] object-cover" src="images/food1.jpg" alt="" style="object-position: 20% 75%" />
                           <div class="p-5">
                              <p class="font-medium">Chicken Cheese Burger</p>
                              <p class="text-sm text-justify">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Labore.</p>
                           </div>
                        </a>
                     </div>
                     <div
