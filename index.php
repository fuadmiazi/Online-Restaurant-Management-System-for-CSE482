      ...
      <div class="scroll-container h-screen w-screen flex flex-col">
         <section class="scroll-child w-screen h-screen">
            <nav class="text-white h-[84.5px] font-medium absolute w-screen z-10 mt-10">
               ...
               <div class="menu flex gap-[250px] justify-center items-center h-full absolute left-[50%] translate-x-[-50%]">
                  <div class="left-menu">
                     <ul class="flex gap-10 text-sm">
                        <li class="hover:text-yellow-500 transition-all duration-75"><a href="#aboutUs">ABOUT</a></li>
                        <li class="hover:text-yellow-500 transition-all duration-75"><a href="#contact">CONTACT</a></li>
                  ...
                  <div class="right-menu">
                     <ul class="flex gap-10 text-sm">
                        ...
                        <li class="hover:text-yellow-500 transition-all duration-75"><a href="profile-page.php">PROFILE</a></li>
            ...
            >
               ...
               <div class="text-gray-200 text-center text-lg border-t-white uppercase font-medium">Bet You Can't Eat Less</div>
               <div class="text-justify border-t-white w-[435px] mt-5 text-neutral-100" style="text-align-last: center">
            ...
            <div class="social-main absolute left-7 top-[50%] translate-y-[-50%] flex flex-col justify-center items-center">
               <div class="cursor-vertical-text text-gray-200 rotate-180 text-xs uppercase" style="writing-mode: vertical-rl">
                  Stay Connected
               </div>
               <div class="h-20 w-[1px] bg-gray-300 my-6 rounded"></div>
               <a href="https://www.facebook.com/khanaseat/" target="_blank"
                  ><img class="w-[30px] mb-2 hover:scale-110 transition-all duration-75" src="images/icons8-facebook.svg" alt=""
               /></a>
               <a href="https://www.instagram.com/khanas_eat/" target="_blank"
                  ><img class="w-[30px] my-2 hover:scale-110 transition-all duration-75" src="images/icons8-instagram.svg" alt=""
               /></a>
               <a href=""
                  ><img class="w-[30px] my-2 hover:scale-110 transition-all duration-75" src="images/icons8-twitter.svg" alt=""
               /></a>
               <a href=""><img class="w-[30px] my-2 hover:scale-110 transition-all duration-75" src="images/icons8-github.svg" alt="" /></a>
               <a href=""
            ...
            >
               <div class="cursor-pointer text-gray-200 rotate-180 text-xs uppercase" style="writing-mode: vertical-rl">Scroll Down</div>
               <div class="h-20 w-[1px] bg-gray-300 my-6 rounded"></div>
            ...
            <div class="grid grid-cols-2 overflow-hidden">
               <div class="flex justify-center items-center flex-col h-[83%]">
                  ...
                  <div class="w-[450px] text-justify text-white mb-10" style="text-align-last: center">
                     Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolorum ex officiis quos quas fugit vero quibusdam est id
         ...
         <section class="scroll-child h-screen bg-[#282421] w-screen relative z-50" id="popular">
            <div class="grid grid-cols-2 overflow-hidden">
               <div class="flex justify-center items-center flex-col h-[83%]">
                  ...
                  <div class="w-[450px] text-justify text-white mb-2 uppercase font-semibold" style="text-align-last: center">
                     <p>DualShock Burger</p>
                  </div>
                  <div class="w-[450px] text-justify text-white mb-2 uppercase">
                     <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Est dolore asperiores impedit nisi quam neque!</p>
                  </div>
